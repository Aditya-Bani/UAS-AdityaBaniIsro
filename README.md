...
![tambahdata](gambar/tambahdata.PNG)


Ubah data

![ubah-data](gambar/ubahdata.PNG)


Lihat data

![lihat-data](gambar/lihatdata.PNG)


Cari data

![cari-data](gambar/caridata.PNG)


Hapus data

![hapus-data](gambar/hapusdata.PNG)
